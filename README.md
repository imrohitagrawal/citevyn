...
| `CITEVYN_PASSWORD_STEP_UP_WINDOW_SECONDS` | optional | How long after redeeming a magic link that same session may set a new password without the old one (default 600, one shot) |
