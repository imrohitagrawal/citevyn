...
| [#71](https://github.com/imrohitagrawal/citevyn/issues/71) | Refactor: share the Tier-3 mismatch predicate between `_vector_arm_enabled` and the orchestrator | retrieval / cache | Low (maintainability; correct today, guarded by a parity test) — **fix open in PR, awaiting merge** | #65 / PR #69 |
