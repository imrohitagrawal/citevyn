...
- A question asked from a **landing entry point** while an answer is in flight
  ...
  - **The refusal itself is announced, not only the state** (#356 gap 2). The
    same region says "Not sent. CiteVyn is still answering your previous question. Your text is kept." It takes the region over rather than living in a second
